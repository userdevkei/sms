...
@section('content')
    ...
    <div class="d-flex flex-wrap justify-content-between align-items-center mb-3 gap-2">
        <div>
            ...
            <p class="text-muted mb-0">Manage students with access to the system.</p>
        </div>
    ...
    <div class="card border-0 shadow-sm">
        <div class="card-body">
            <div class="table-responsive">
                <table id="usersTable" class="table table-hover table-sm table-striped fs-sm w-100">
                    <thead>
                    <tr>
                        <th>#</th>
                        <th></th>
...
@push('scripts')
    <script>
        const exportPdfUrl = @json(route('students.export.pdf'));
        const exportExcelUrl = @json(route('students.export.excel'));
    </script>
@endpush
